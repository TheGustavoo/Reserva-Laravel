        ...
        <div class="d-flex align-items-center mb-4 pb-2">
            ...
            <div>
                ...
                <h2 class="fw-bold mb-0 text-dark" style="letter-spacing: -0.5px;">
                    Cadastrar <span style="color: #4338ca;">Professor</span>
                </h2>
            </div>
        </div>
            ...
            <form action="{{ route('professores.store') }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <input type="text" name="nome" id="nome" class="form-control" placeholder="Ex: Gustavo Silva" required autocomplete="off">
                    </div>

                    <div class="col-12">
                        <label for="materia" class="form-label">
                            <i class="bi bi-book fs-6 text-primary opacity-75"></i> Matéria / Disciplina
                        </label>
                        <input type="text" name="materia" id="materia" class="form-control" placeholder="Ex: Programação Web" required autocomplete="off">
                        <div class="hint-text">
                            <i class="bi bi-info-circle"></i> Área de especialidade ou disciplina principal do professor.
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="btn-action-group">
                            ...
                            <button type="submit" class="btn-save">
                                <i class="bi bi-cloud-arrow-up fs-5"></i> Salvar Professor
                            </button>
                        </div>
                    </div>
                </div>
