        ...
        <div class="d-flex align-items-center mb-4 pb-2">
            ...
            <div>
                ...
                <h2 class="fw-bold mb-0 text-dark" style="letter-spacing: -0.5px;">
                    Editar <span style="color: #4338ca;">Sala #{{ str_pad($sala->id, 4, '0', STR_PAD_LEFT) }}</span>
                </h2>
            </div>
        </div>
            ...
            <form action="{{ route('salas.update', $sala->id) }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <input type="text" name="descricao" id="descricao" class="form-control" value="{{ $sala->descricao ?? $sala->nome }}" placeholder="Ex: Laboratório de Informática 01" required autocomplete="off">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="number" name="capacidade" id="capacidade" class="form-control" value="{{ $sala->capacidade }}" placeholder="Ex: 30" min="1" required>
                    </div>
