...
<body class="p-4 p-md-5 d-flex align-items-center justify-content-center" style="min-height: 100vh;">
    ...
    <div class="container" style="max-width: 550px; width: 100%;">
        ...
        <div class="d-flex align-items-center mb-4 pb-2">
            <a href="{{ route('salas.index') }}" class="back-icon me-4" title="Voltar para a lista">
            ...
            <div>
                ...
                <h2 class="fw-bold mb-0 text-dark" style="letter-spacing: -0.5px;">
                    Cadastrar <span style="color: #4338ca;">Sala</span>
                </h2>
            </div>
        </div>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <label for="descricao" class="form-label">
                            <i class="bi bi-building fs-6 text-primary opacity-75"></i> Identificação da Sala
                        </label>
                        <input type="text" name="descricao" id="descricao" class="form-control" placeholder="Ex: Laboratório de Informática 01" required autocomplete="off">
                    </div>

                    <div class="col-12">
                        <label for="capacidade" class="form-label">
                            <i class="bi bi-people fs-6 text-primary opacity-75"></i> Capacidade Máxima
                        </label>
                        <input type="number" name="capacidade" id="capacidade" class="form-control" placeholder="Ex: 30" min="1" required>
                        <div class="hint-text">
                            <i class="bi bi-info-circle"></i> Quantidade máxima de pessoas que o espaço comporta.
                        </div>
                    </div>

                    <div class="col-12">
                        <div class="btn-action-group">
                            <a href="{{ route('salas.index') }}" class="btn-cancel">
                                Cancelar
                            </a>
                            <button type="submit" class="btn-save">
                                <i class="bi bi-cloud-arrow-up fs-5"></i> Salvar Cadastro
                            </button>
                        </div>
                    </div>
                </div>
